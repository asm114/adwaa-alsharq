...
(()=>{const script=document.createElement('script');script.defer=true;script.src='booking-welcome-confirmation.js?v=20260918-2';script.onerror=()=>console.warn('تعذر تحميل ترحيب وتأكيد الحجز');document.head.appendChild(script)})();
