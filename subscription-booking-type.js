...
(()=>{const script=document.createElement('script');script.async=false;script.src='operational-reminders-center.js?v=20260818-4';script.onerror=()=>console.warn('تعذر تحميل مركز التنبيهات التشغيلية');document.head.appendChild(script)})();
...
(()=>{const script=document.createElement('script');script.async=false;script.src='deposit-refund-policy.js?v=20260918-2';script.onerror=()=>console.warn('تعذر تحميل سياسة العربون والإرجاع');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='booking-save-stability.js?v=20260921-1';script.onerror=()=>console.warn('تعذر تحميل حماية حفظ الحجز');document.head.appendChild(script)})();
