...
(()=>{const script=document.createElement('script');script.async=false;script.src='operational-reminders-center.js?v=20260921-2';script.onerror=()=>console.warn('تعذر تحميل مركز التنبيهات التشغيلية');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='professional-ui-stable.js?v=20260921-2';script.onerror=()=>console.warn('تعذر تحميل تحسينات الواجهة المستقرة');document.head.appendChild(script)})();
...
(()=>{const script=document.createElement('script');script.async=false;script.src='booking-save-stability.js?v=20260921-2';script.onerror=()=>console.warn('تعذر تحميل حماية حفظ الحجز');document.head.appendChild(script)})();
