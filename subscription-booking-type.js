...
(()=>{const script=document.createElement('script');script.src='subscription-editing.js?v=20260807-1';script.defer=true;script.onerror=()=>console.warn('تعذر تحميل تعديل الاشتراكات');document.head.appendChild(script)})();
