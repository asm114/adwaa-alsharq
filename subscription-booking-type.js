...
(()=>{const script=document.createElement('script');script.async=false;script.src='portal-admin-client.js?v=20260813-1';script.onerror=()=>console.warn('تعذر تحميل جلسة إدارة بوابة العملاء');document.head.appendChild(script)})();
