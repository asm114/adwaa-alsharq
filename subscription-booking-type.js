...
(()=>{const script=document.createElement('script');script.async=false;script.src='deposit-refund-policy.js?v=20260914-1';script.onerror=()=>console.warn('تعذر تحميل سياسة العربون والإرجاع');document.head.appendChild(script)})();
