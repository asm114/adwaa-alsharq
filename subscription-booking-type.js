...
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-draft-workflow.js?v=20260922-2';document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-editing.js?v=20260922-2';script.onerror=()=>console.warn('تعذر تحميل تعديل الاشتراكات');document.head.appendChild(script)})();
...
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-calendar-booking-labels.js?v=20260922-1';script.onerror=()=>console.warn('تعذر تحميل تسميات تقويم الاشتراك');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-customer-finance.js?v=20260922-2';script.onerror=()=>console.warn('تعذر تحميل ربط مالية الاشتراك بالعميل');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-flexible-enhancements.js?v=20260922-2';script.onerror=()=>console.warn('تعذر تحميل تحسينات الاشتراكات المرنة');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-control-center.js?v=20260922-2';script.onerror=()=>console.warn('تعذر تحميل مركز إدارة الاشتراك');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-commission-core.js?v=20260922-2';script.onerror=()=>console.warn('تعذر تحميل عمولة الاشتراك الرئيسية');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-revenue-integration.js?v=20260922-2';script.onerror=()=>console.warn('تعذر تحميل ربط إيرادات الاشتراك');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='commission-transfer-workflow.js?v=20260922-2';script.onerror=()=>console.warn('تعذر تحميل سير تحويل العمولة اليدوي');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='resort-account-balance.js?v=20260921-1';script.onerror=()=>console.warn('تعذر تحميل رصيد حساب المنتجع');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='operational-reminders-center.js?v=20260922-1';script.onerror=()=>console.warn('تعذر تحميل مركز التنبيهات التشغيلية');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='professional-ui-stable.js?v=20260922-2';script.onerror=()=>console.warn('تعذر تحميل تحسينات الواجهة المستقرة');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='home-dashboard-polish.js?v=20260819-3';script.onerror=()=>console.warn('تعذر تحميل تحسينات الصفحة الرئيسية');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='daily-operations-policy.js?v=20260922-1';script.onerror=()=>console.warn('تعذر تحميل سياسة التشغيل اليومية');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='deposit-refund-policy.js?v=20260921-2';script.onerror=()=>console.warn('تعذر تحميل سياسة العربون والإرجاع');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='booking-save-stability.js?v=20260922-1';script.onerror=()=>console.warn('تعذر تحميل حماية حفظ الحجز');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='deposit-input-stability.js?v=20260916-1';script.onerror=()=>console.warn('تعذر تحميل حماية إدخال العربون');document.head.appendChild(script)})();
(()=>{setTimeout(()=>{const script=document.createElement('script');script.async=false;script.src='portal-dedicated-backend-compat.js?v=20260916-5';script.onerror=()=>console.warn('تعذر تحميل ربط بوابة العملاء المخصصة');document.head.appendChild(script)},1200)})();
