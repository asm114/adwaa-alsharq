...
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-flexible-enhancements.js?v=20260922-1';script.onerror=()=>console.warn('تعذر تحميل تحسينات الاشتراكات المرنة');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-control-center.js?v=20260922-1';script.onerror=()=>console.warn('تعذر تحميل مركز إدارة الاشتراك');document.head.appendChild(script)})();
...
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-revenue-integration.js?v=20260922-1';script.onerror=()=>console.warn('تعذر تحميل ربط إيرادات الاشتراك');document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.async=false;script.src='commission-transfer-workflow.js?v=20260922-1';script.onerror=()=>console.warn('تعذر تحميل سير تحويل العمولة اليدوي');document.head.appendChild(script)})();
...
(()=>{const script=document.createElement('script');script.async=false;script.src='professional-ui-stable.js?v=20260922-1';script.onerror=()=>console.warn('تعذر تحميل تحسينات الواجهة المستقرة');document.head.appendChild(script)})();
