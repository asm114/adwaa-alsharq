...
(()=>{const script=document.createElement('script');script.async=false;script.src='commission-transfer-workflow.js?v=20260813-1';script.onerror=()=>console.warn('تعذر تحميل سير تحويل العمولة اليدوي');document.head.appendChild(script)})();
...
(()=>{const script=document.createElement('script');script.async=false;script.src='daily-operations-policy.js?v=20260813-1';script.onerror=()=>console.warn('تعذر تحميل سياسة التشغيل اليومية');document.head.appendChild(script)})();
