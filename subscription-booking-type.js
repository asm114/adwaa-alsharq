...
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-transfer-date-preview-fix.js?v=20260808-1';script.onerror=()=>console.warn('تعذر تحميل إصلاح عرض تواريخ الترحيل');document.head.appendChild(script)})();
