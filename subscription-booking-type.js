...
(()=>{const script=document.createElement('script');script.async=false;script.src='resort-account-balance.js?v=20260920-1';script.onerror=()=>console.warn('تعذر تحميل رصيد حساب المنتجع');document.head.appendChild(script)})();
...
(()=>{const script=document.createElement('script');script.async=false;script.src='booking-save-stability.js?v=20260915-1';script.onerror=()=>console.warn('تعذر تحميل حماية حفظ الحجز');document.head.appendChild(script)})();
