...
(()=>{const script=document.createElement('script');script.async=false;script.src='subscription-revenue-integration.js?v=20260808-1';script.onerror=()=>console.warn('تعذر تحميل ربط دفعات الاشتراك بالإيرادات');document.head.appendChild(script)})();
