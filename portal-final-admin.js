...
(()=>{const script=document.createElement('script');script.src='subscription-booking-type.js?v=20260808-2';script.defer=true;document.head.appendChild(script)})();
(()=>{const script=document.createElement('script');script.src='booking-customer-groups.js?v=20260808-2';script.defer=true;script.onerror=()=>console.warn('تعذر تحميل تجميع الحجوزات حسب العميل');document.head.appendChild(script)})();
