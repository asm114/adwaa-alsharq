...
(()=>{const script=document.createElement('script');script.src='remaining-payment-flow.js?v=20260921-2';script.defer=true;script.onerror=()=>console.warn('تعذر تحميل استلام باقي المبلغ');document.head.appendChild(script)})();
...
(()=>{const script=document.createElement('script');script.src='booking-customer-groups.js?v=20260921-2';script.defer=true;script.onerror=()=>console.warn('تعذر تحميل تجميع الحجوزات حسب العميل');document.head.appendChild(script)})();
...
(()=>{const script=document.createElement('script');script.src='portal-booking-sync-stable.js?v=20260831-1';script.defer=true;script.onerror=()=>console.warn('تعذر تحميل المزامنة المستقرة مع بوابة العملاء');document.head.appendChild(script)})();
