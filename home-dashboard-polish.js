...
function addStyles(){
  ...
  if(!document.querySelector('script[data-home-metric-drilldowns]')){
    const script=document.createElement('script');script.src='home-metric-drilldowns.js?v=20260922-1';script.defer=true;script.dataset.homeMetricDrilldowns='1';document.head.appendChild(script);
  }
