-- Commercial Customer Portal: base public pricing for a fresh customer install.
-- Customer-neutral by design: no AAS values, customer prices, emails, project refs, or secrets.
...
comment on column public.customer_portal_pricing.weekend_price is
  'Base weekend price. Zero means no public price has been configured yet.';

-- A neutral singleton row keeps the current portal runtime compatible on Fresh Install.
-- Zero is configuration-empty, not a customer price or operational seed.
