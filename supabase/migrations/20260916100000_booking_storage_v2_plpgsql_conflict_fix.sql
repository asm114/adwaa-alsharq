-- Booking storage v2 PL/pgSQL name-conflict fix.
-- The RPC returns columns named reservation_id/revision. Prefer table columns when an
-- unqualified SQL identifier collides with those PL/pgSQL output variables.
...
begin
  ...
  if v_reservation_id is null then
    ...
    insert into public.reservations as saved (
    ...
    returning saved.id, saved.revision into v_reservation_id, v_new_revision;
  else
