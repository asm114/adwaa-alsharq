-- Booking storage v2 save RPC fix.
-- Qualify the INSERT ... RETURNING columns because the function's output column
-- named revision otherwise conflicts with reservations.revision in PL/pgSQL.
